                    ...
                    <div class="form-outline">
                      ...
                      <div class="d-md-flex justify-content-start align-items-center mb-4 py-2">
                        ...
                        <div class="form-check form-check-inline mb-0 me-4">
                          <input
                            ...
                            value="option1"
                          />
                          <label class="form-check-label" htmlFor="femaleGender">
                            Female
                          </label>
                        </div>
                        ...
                        <div className="form-check form-check-inline mb-0 me-4">
                          <input
                            ...
                            value="option2"
                          />
                          <label class="form-check-label" htmlFor="maleGender">
                            Male
                          </label>
                        </div>
                      ...
                      <div class="form-outline mb-4">
                        <input
                          ...
                          id="form3Example8"
                          class="form-control form-control-lg"
                          value={userRegistration.Address1} onChange={handleInput}
                              name="Address1"
                        />
                      ...
                      <div class="form-outline mb-4">
                        <input
                          ...
                          id="form3Example8"
                          class="form-control form-control-lg"
                          value={userRegistration.Address2} onChange={handleInput}
                              name="Address2"
                        />
                        <label class="form-label" for="form3Example8">
                          Address Line 2
                      ...
                      <div class="form-outline mb-4">
                        <input
                          ...
                          id="form3Example90"
                          class="form-control form-control-lg"
                          value={userRegistration.zipcode} onChange={handleInput}
                              name="zipcode"
                        />
                      ...
                      <div class="d-flex justify-content-end pt-3">
                        ...
                        <button
                          type="button" name="records" onClick={handleSubmit}
      ...
      <thead>
        ...
        {records.map((curElem)=> {
            return(<tr >
                ...
                <td>{curElem.email}</td>
                <td>{curElem.Address1}</td>
                <td>{curElem.Address2}</td>
                <td>{curElem.zipcode}</td>
                </tr> 
                );
